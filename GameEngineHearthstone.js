...
var DirectorImagini = "Imagini/imgHearthstone/";
...
var afisareMatrice = function() {
    ...
    for(var i = 1; i <= N; ++ i) {
        ...
        for(var j = 1;j <= M; ++ j) {
            ...
            imag.src = DirectorImagini + matrix[i][j] + ExtensieImagini;
...
var afiseazaLegenda = function() {
    ...
    for(var i = 0; i < Cells.length; ++i) {
        ...
        var imag = document.createElement("img");
        imag.src = DirectorImagini + Cells[i] + ExtensieImagini;
        imag.width = pixi - 16;
        imag.height = pixi - 16;
        imag.style.borderRadius = "3px";
